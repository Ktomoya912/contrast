...
def plot_training_progress(learner: TDLearner, save_path: str = "training_progress.png"):
    """学習の進捗をグラフ化"""
...
def main():
    ...
    parser.add_argument('--episodes', type=int, default=1000,
                      help='学習エピソード数 (デフォルト: 1000)')
    parser.add_argument('--learning-rate', type=float, default=0.001,
                      help='学習率 (デフォルト: 0.001)')
    parser.add_argument('--discount', type=float, default=0.95,
                      help='割引率 (デフォルト: 0.95)')
    parser.add_argument('--epsilon', type=float, default=0.2,
                      help='ε-greedyのε (デフォルト: 0.2)')
    parser.add_argument('--lambda-td', type=float, default=0.7,
                      help='TD(λ)のλ (デフォルト: 0.7)')
    parser.add_argument('--save-interval', type=int, default=100,
                      help='モデル保存間隔 (デフォルト: 100)')
    parser.add_argument('--model-path', type=str, default='contrast_ai.pth',
                      help='モデルの保存パス (デフォルト: contrast_ai.pth)')
    parser.add_argument('--load-model', type=str, default=None,
                      help='既存モデルを読み込んで学習を継続')
    parser.add_argument('--plot', action='store_true',
                      help='学習進捗をグラフ化')
    parser.add_argument('--cuda', action='store_true',
                      help='CUDAを使用する（GPUがある場合）')
    ...
    print("\n次のコマンドでAIと対戦できます:")
    print(f"  python3 play_with_ai.py")
