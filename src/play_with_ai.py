...
def play_vs_ai(model_path: str = "contrast_ai.pth", use_cuda: bool = False):
    ...
    # AIを読み込み
    print("AIを読み込んでいます...")
    learner = TDLearner(board_size=5, epsilon=0.0, use_cuda=use_cuda)  # ε=0（常に最良手を選択）
                ...
                if get_yes_no_input("タイルを配置しますか？ (y/n): "):
                    ...
                    while True:
                        ...
                        if tile_type in ['black', 'b', '黒'] and tiles['black'] > 0:
                            ...
                            break
                        elif tile_type in ['gray', 'grey', 'g', 'グレー'] and tiles['gray'] > 0:
...
def watch_ai_vs_ai(model_path: str = "contrast_ai.pth", num_games: int = 5, use_cuda: bool = False):
    """AI同士の対戦を観戦"""
    print("="*60)
    print("AI同士の対戦を観戦")
    print("="*60)
